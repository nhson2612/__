...
packages/
  functions/      # Backend (Firebase Functions, API, business logic)
    src/
      ...
      routes/         # Centralized API endpoint definitions (makeRequest.js)
      ...
...
- **API Routing:** All admin endpoints in `functions/src/routes/makeRequest.js`
...
- Reference `functions/src/routes/makeRequest.js` for backend endpoints
